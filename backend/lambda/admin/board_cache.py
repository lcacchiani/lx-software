...
depend on the question. AWS cost/alarms/health and security findings are.
"""
...
def refresh_all(table: Any) -> dict[str, Any]:
    ...
    return {"aws": aws_notes, "security": sec_notes}
...
def handle_schedule_trigger(_event: dict[str, Any]) -> dict[str, Any]:
    ...
    _log_event("info", tag="board_cache_refreshed", aws=result.get("aws"), security=result.get("security"))
