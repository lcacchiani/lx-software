...
import { type FinanceAllocationRecord, newCustomAllocationExpenseId } from "../lib/financeModel";
...
import {
  allocationLastUpdatedDisplay,
  allocationMonthlyColumnDisplay,
  allocationTagsCellLabel,
  compareAllocations,
  linkedStoredRowPatch,
  type AllocSortKey,
} from "./FinanceAllocationsPanel.utils";
